...
INSERT INTO key_value_store (key, value) VALUES ('lumen_address_index', '0');
...
CREATE TYPE event AS ENUM ('transaction_received', 'account_created', 'exchanged', 'exchanged_timelocked', 'account_config_error');
